...
[![App](https://img.shields.io/badge/app-2.7.0-1B4F72)](https://destroyer.jonbailey.xyz)
[![KB](https://img.shields.io/badge/KB-3.18.0-117A65)](https://destroyer.jonbailey.xyz)
...
**Current corpus (KB 3.18.0):** 209 unique curated claims (legacy seed plus v2 bundles, de-duplicated by id), 11 top-level topic families, 120 bundled public-domain full texts, and 16 catalog-only copyrighted titles with external links.
...
|---------|--------|--------------------|
| Topic tree + claim detail | Shipped | 209 unique claims, steelman first, sources, Battle Brief copy, 1200x630 Battle Card PNG |
