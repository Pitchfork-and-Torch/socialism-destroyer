...
[![App](https://img.shields.io/badge/app-2.9.0-1B4F72)](https://destroyer.jonbailey.xyz)
[![KB](https://img.shields.io/badge/KB-3.20.0-117A65)](https://destroyer.jonbailey.xyz)
...
**Current corpus (KB 3.20.0):** 225 unique curated claims (legacy seed plus v2 bundles, de-duplicated by id), 11 top-level topic families, 120 bundled public-domain full texts, and 16 catalog-only copyrighted titles with external links.
...
|---------|--------|--------------------|
| Topic tree + claim detail | Shipped | 225 unique claims, steelman first, sources, Battle Brief, Hearing Brief, ready post, 1200x630 Battle Card PNG |
