...
[![KB](https://img.shields.io/badge/KB-3.18.1-117A65)](https://destroyer.jonbailey.xyz)
...
**Current corpus (KB 3.18.1):** 209 unique curated claims (legacy seed plus v2 bundles, de-duplicated by id), 11 top-level topic families, 120 bundled public-domain full texts, and 16 catalog-only copyrighted titles with external links.
