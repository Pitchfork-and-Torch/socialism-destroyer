...
## Shipped in 3.20.0 (2026-09-26)

- High-intent wave10 Statute Desk (8 claims): PRO Act, right-to-work repeal, public bank in every state, abolish the debt ceiling, Bayh-Dole march-in, retail digital dollar, inclusionary zoning, eviction bans
- Ready post on claim detail (steelman-first copy plus claim URL)
- 225 unique claims / 23 bundles; App 2.9.0; OG ?v=3.20.0
...
6. Broader ready-post variants (thread length, source line) if the one-tap post is not enough
