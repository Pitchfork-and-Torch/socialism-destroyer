...
class ArgumentAnalyzer {
  ...
  static const _intentLabels = <String, String>{
    ...
    'statute-desk': 'Statute & public money',
  ...
  static const _synonymExpansions = <String, List<String>>{
    ...
    'pro act': ['protecting the right to organize', 'h.r. 20', 'right to organize'],
    'right to work': ['taft-hartley', 'fair-share', 'section 14(b)'],
    'public bank': ['bank of north dakota', 'state-owned bank'],
    'debt ceiling': ['debt limit', 'face amount'],
    'bayh-dole': ['march-in', 'march in', 'subject invention'],
    'digital dollar': ['central bank digital', 'retail cbdc', 'public account'],
    'inclusionary zoning': ['affordable set-aside', 'below-market units'],
    'eviction ban': ['eviction moratorium', 'cdc moratorium'],
