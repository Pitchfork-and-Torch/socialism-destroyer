...
class ClaimRanker {
  static const _phraseClaimBoosts = <String, List<String>>{
    ...
    'buyback': ['stock-buybacks-are-theft', 'ban-stock-buybacks'],
    'share repurchase': ['stock-buybacks-are-theft', 'ban-stock-buybacks'],
    ...
    'public bank': ['public-bank-every-state', 'postal-banking-is-justice'],
    'sectoral bargaining': ['sectoral-bargaining-is-democracy', 'mandatory-worker-ownership'],
    'sectoral': ['sectoral-bargaining-is-democracy'],
    'right-to-work': ['repeal-right-to-work', 'sectoral-bargaining-is-democracy'],
    'right to work': ['repeal-right-to-work', 'sectoral-bargaining-is-democracy'],
    ...
    // Wave 7 high-intent (KB 3.17 Supply Desk)
    'lng': ['ban-lng-exports-until-cheap'],
    'lng export': ['ban-lng-exports-until-cheap'],
    'liquefied natural': ['ban-lng-exports-until-cheap'],
    'ban lng': ['ban-lng-exports-until-cheap'],
    'gas export': ['ban-lng-exports-until-cheap', 'no-new-oil-gas-leases'],
    'oil lease': ['no-new-oil-gas-leases'],
    'gas lease': ['no-new-oil-gas-leases'],
    'public land': ['no-new-oil-gas-leases'],
    'lease freeze': ['no-new-oil-gas-leases'],
    'blm lease': ['no-new-oil-gas-leases'],
    'private water': ['water-is-a-human-right-ban-private', 'public-power-is-justice'],
    'water is a human right': ['water-is-a-human-right-ban-private'],
    'water utility': ['water-is-a-human-right-ban-private'],
    'municipalize water': ['water-is-a-human-right-ban-private'],
    'factory farm': ['ban-factory-farms-food-justice'],
    'cafo': ['ban-factory-farms-food-justice'],
    'cafos': ['ban-factory-farms-food-justice'],
    'animal feeding': ['ban-factory-farms-food-justice'],
    'freight rail': ['nationalize-freight-rail', 'nationalize-critical-infrastructure'],
    'nationalize rail': ['nationalize-freight-rail'],
    'class i': ['nationalize-freight-rail'],
    'class 1 railroad': ['nationalize-freight-rail'],
    'foreign farmland': ['ban-foreign-farmland'],
    'foreign farm': ['ban-foreign-farmland'],
    'afida': ['ban-foreign-farmland'],
    'farmland': ['ban-foreign-farmland', 'ban-factory-farms-food-justice'],
    'food export': ['ban-food-exports-until-cheap', 'grocery-price-controls-now'],
    'ban food export': ['ban-food-exports-until-cheap'],
    'agricultural export': ['ban-food-exports-until-cheap'],
    'grain export': ['ban-food-exports-until-cheap'],
    'municipal broadband': ['municipal-broadband-only'],
    'public broadband': ['municipal-broadband-only'],
    'public utility broadband': ['municipal-broadband-only'],
    'private isp': ['municipal-broadband-only'],
    'municipalize internet': ['municipal-broadband-only'],
    // Wave 8 high-intent (KB 3.18 Household Capture)
    'cancel all federal student': ['cancel-all-student-debt', 'student-loan-pause-is-justice'],
    'cancel student debt': ['cancel-all-student-debt', 'student-loan-pause-is-justice'],
    'wipe student loan': ['cancel-all-student-debt'],
    'student loan book': ['cancel-all-student-debt'],
    'junk fee': ['ban-junk-fees-is-justice'],
    'junk fees': ['ban-junk-fees-is-justice'],
    'advertised number': ['ban-junk-fees-is-justice'],
    'surprise add-on': ['ban-junk-fees-is-justice'],
    'public childcare': ['universal-public-childcare'],
    'free public utility like kindergarten': ['universal-public-childcare'],
    'childcare a free': ['universal-public-childcare'],
    'private prison': ['ban-private-prisons'],
    'private prisons': ['ban-private-prisons'],
    'contractor beds': ['ban-private-prisons'],
    'congress from trading': ['ban-congress-stock-trading'],
    'members of congress': ['ban-congress-stock-trading'],
    'stock trading': ['ban-congress-stock-trading'],
    'payday loan': ['ban-payday-loans', 'cap-credit-card-interest'],
    'payday loans': ['ban-payday-loans'],
    'triple-digit apr': ['ban-payday-loans'],
    'medical debt': ['forgive-all-medical-debt', 'insulin-price-cap-is-justice'],
    'hospital bills': ['forgive-all-medical-debt'],
    'collections industry': ['forgive-all-medical-debt'],
    'stock buyback': ['ban-stock-buybacks', 'executive-pay-ratio-cap', 'stock-buybacks-are-theft'],
    'stock buybacks': ['ban-stock-buybacks', 'stock-buybacks-are-theft'],
    'juicing the ticker': ['ban-stock-buybacks'],
    // Wave 9 high-intent (KB 3.19 Planning Desk)
    'social wealth fund': ['social-wealth-fund-owns-the-market'],
    'slice of every large': ['social-wealth-fund-owns-the-market'],
    'resident dividend': ['social-wealth-fund-owns-the-market'],
    'federal job guarantee': ['federal-job-guarantee-last-resort'],
    'employer of last resort': ['federal-job-guarantee-last-resort'],
    'living-wage public job': ['federal-job-guarantee-last-resort'],
    'modern monetary theory': ['mmt-deficits-do-not-bind'],
    'currency issuer': ['mmt-deficits-do-not-bind'],
    'deficits do not': ['mmt-deficits-do-not-bind'],
    'spend first': ['mmt-deficits-do-not-bind'],
    'tariff wall': ['tariff-wall-rebuilds-wages'],
    'foreigners pay': ['tariff-wall-rebuilds-wages'],
    'broad tariff': ['tariff-wall-rebuilds-wages'],
    'national investment bank': ['national-investment-bank-picks-credit'],
    'allocate credit': ['national-investment-bank-picks-credit'],
    'public development bank': ['national-investment-bank-picks-credit'],
    'codetermination': ['codetermination-half-the-board'],
    'half the board': ['codetermination-half-the-board'],
    'worker directors': ['codetermination-half-the-board'],
    'vienna model': ['vienna-social-housing-is-the-model'],
    'limited-profit': ['vienna-social-housing-is-the-model'],
    'capital controls': ['capital-controls-make-wealth-taxes-stick'],
    'exit tax': ['capital-controls-make-wealth-taxes-stick'],
    'lock the fortunes': ['capital-controls-make-wealth-taxes-stick'],
    // Wave 10 high-intent (KB 3.20 Statute Desk)
    'pro act': ['pro-act-restores-organizing'],
    'h.r. 20': ['pro-act-restores-organizing'],
    'right to organize': ['pro-act-restores-organizing'],
    'section 14(b)': ['repeal-right-to-work'],
    'fair-share fees': ['repeal-right-to-work'],
    'bank of north dakota': ['public-bank-every-state'],
    'public bank in every': ['public-bank-every-state'],
    'household deposits': ['public-bank-every-state'],
    'debt ceiling': ['abolish-the-debt-ceiling'],
    'hostage crisis': ['abolish-the-debt-ceiling'],
    'bayh-dole': ['bayh-dole-march-in-sets-prices'],
    'march-in': ['bayh-dole-march-in-sets-prices'],
    'march in': ['bayh-dole-march-in-sets-prices'],
    'digital dollar': ['retail-cbdc-replaces-deposits'],
    'central bank digital': ['retail-cbdc-replaces-deposits'],
    'central-bank digital': ['retail-cbdc-replaces-deposits'],
    'inclusionary zoning': ['inclusionary-zoning-is-owed'],
    'below-market': ['inclusionary-zoning-is-owed'],
    'eviction ban': ['eviction-bans-are-housing-policy'],
    'cdc moratorium': ['eviction-bans-are-housing-policy'],
    'ban evictions': ['eviction-bans-are-housing-policy'],
  };
  ...
  static List<MatchedClaimRef> rank({
    ...
    for (final hit in hits) {
      ...
      if (analysis.detectedTopicIds.isNotEmpty) {
        if (topicFamilyMatches(claim, analysis.detectedTopicIds)) {
          score += 0.35;
        } else {
          score -= 0.3;
        }
  ...
  /// Parent analyzer ids (e.g. government-intervention) must match child
  /// claim.topicId (minimum-wage, household-capture) via [Claim.topicPath].
  static bool topicFamilyMatches(Claim claim, List<String> detectedTopicIds) {
    if (detectedTopicIds.isEmpty) return false;
    final tid = claim.topicId.toLowerCase();
    final pathParts = (claim.topicPath ?? '')
        .toLowerCase()
        .split('/')
        .where((p) => p.isNotEmpty)
        .toSet();
    for (final raw in detectedTopicIds) {
      final d = raw.toLowerCase();
      if (d.isEmpty) continue;
      if (tid == d) return true;
      if (pathParts.contains(d)) return true;
    }
    return false;
  }
}