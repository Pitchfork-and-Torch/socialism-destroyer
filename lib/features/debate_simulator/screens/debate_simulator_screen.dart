            ...
            ...items.map(
              (s) => ListTile(
                ...
                trailing: IconButton(
                  ...
                  tooltip: 'Delete session ${s.title}',
                  onPressed: () async {
                    await ref
                        .read(activeDebateProvider.notifier)
                        .delete(s.id);
              ...
              if (showScoreToggle)
                Align(
                  ...
                  child: Semantics(
                    ...
                    selected: scoreNext,
                    label: scoreNext
                        ? 'Score this reply enabled'
                        : 'Score this reply disabled',
                    child: FilterChip(
              ...
              Row(
                ...
                children: [
                  ...
                  Semantics(
                    button: true,
                    enabled: !loading,
                    label: loading ? 'Sending reply' : 'Send debate reply',
                    child: FilledButton(
