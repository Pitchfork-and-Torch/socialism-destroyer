...
class _ChangelogBody extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    // Defense in depth: never trust entry order from merge/cache.
    final entries = List<ChangelogEntry>.from(document.entries)
      ..sort(
        (a, b) => KnowledgeVersion.compare(b.version, a.version),
      );
