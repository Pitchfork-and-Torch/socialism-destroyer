...
void main() {
  group('ClaimRanker.topicFamilyMatches', () {
    ...
    test('statute-desk child matches government-intervention via topicPath', () {
      final claim = Claim(
        id: 'statute-sample',
        topicId: 'statute-desk',
        topicPath: '/government-intervention/statute',
        title: 'Sample statute claim',
        socialistClaimText: 'Pass the statute.',
        executiveSummary: 'The statute already says otherwise.',
        evidenceBullets: const ['A'],
        fallacies: const ['seen vs unseen'],
        sources: const [],
        whyItMatters: 'Statutes matter.',
        relatedClaimIds: const [],
        tags: const ['statute-desk'],
        schemaVersion: 2,
        revision: 1,
        updatedAt: '2026-09-26T16:00:00Z',
        embeddingText: 'statute',
        searchText: 'statute',
        kbVersion: '3.20.0',
      );
      expect(
      ...
      expect(
        ClaimRanker.topicFamilyMatches(claim, ['statute-desk']),
        isTrue,
      );
    });
