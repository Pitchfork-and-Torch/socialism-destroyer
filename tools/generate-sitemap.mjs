...
const priorityClaims = new Set([
  ...
  'ban-pe-from-hospitals',
  'insulin-price-cap-is-justice',
  'vacancy-tax-fills-homes',
  'postal-banking-is-justice',
  'sectoral-bargaining-is-democracy',
  ...
  'tax-pause-ai-data-centers',
  'public-power-is-justice',
  'financial-transaction-tax-justice',
  'abolish-inherited-wealth',
  'twenty-five-dollar-minimum-wage',
  'ban-lng-exports-until-cheap',
  'no-new-oil-gas-leases',
  'water-is-a-human-right-ban-private',
  'ban-factory-farms-food-justice',
  'nationalize-freight-rail',
  'ban-foreign-farmland',
  'ban-food-exports-until-cheap',
  'municipal-broadband-only',
]);
